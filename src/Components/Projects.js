...
const Projects = () => {
	...
	return (
		<div className='pt-20  max-w-5xl mx-auto '>
			<h1 className='text-5xl inter font-bold '>
				Projects <span className=''>[{FilteredProjects.length}]</span>
			</h1>
			...
			<input
				...
				value={search}
				className='bg-[#25282A] p-2 mt-1 rounded-lg shadow-xl w-full outline-none'
				onChange={(e) => {
			...
			<div className='grid grid-cols-1 gap-10 py-5 lg:px-20 md:px-10 px-5'>
				{FilteredProjects.map((project) => {
					...
					return (
						<div
							className={`bg-[#25282A]  rounded-lg  grid md:grid-cols-2 lg:p-[45px] p-[30px] gap-4 bg-[#2] px-10 `}>
							<div>
								<img
									src={project.Img}
