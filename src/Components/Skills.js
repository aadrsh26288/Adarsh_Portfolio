    ...
    <section className="mx-auto max-w-[85%] mt-24">
      ...
      >
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"   >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">HTML</p>
            </motion.div>
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"  >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">CSS</p>
            </motion.div>
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"   >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">Javascript</p>
            </motion.div>
            ...
            <motion.div variants={popUp}  className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group" >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">React</p>
            </motion.div>
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"   >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">Tailwind CSS</p>
            </motion.div>
            ...
            <motion.div variants={popUp}  className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"  >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">Firebase</p>
            </motion.div>
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"   >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">Redux</p>
            </motion.div>
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"   >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">Git</p>
            </motion.div>
            ...
            <motion.div variants={popUp} className="p-4 select-none  flex items-center justify-center sm:justify-start gap-4  hover:bg-[#25282A] border rounded-sm border-neutral-700  transform origin-center md:origin-top group"   >
              ...
              <p className="hidden inter  sm:inline-flex text-sm md:text-base font-semibold  ">Github</p>
            </motion.div>
